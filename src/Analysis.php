    ...
    public static function install()
    {
        static::getDriver()->install([
            ...
            'request' => [
                ...
                'http_code' => ['type' => 'int', 'length' => 3, 'null' => true],
                'method' => ['type' => 'varchar', 'length' => 10, 'null' => true],
                'url' => ['type' => 'varchar', 'length' => 255, 'null' => true],
                'ip' => ['type' => 'varchar', 'length' => 100, 'null' => true],
                'referer' => ['type' => 'varchar', 'length' => 255, 'null' => true],
                'useragent' => ['type' => 'varchar', 'length' => 255, 'null' => true],
